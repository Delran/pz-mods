...
Tests.TestOptionAddedWithOldTweakerAPIBetweenCallsShouldStillAppear = function()
    ...
    TweakItem(targetItem, "ClothingItemExtra", "Blabla1;Blabla2;MustNotAppear;MustNotAppear2")
    TweakItem(targetItem, "ClothingItemExtraOption", "HoodieUp;HoodieDown;TieOnWaist;HoodieUp")
    ...
    "TieOnWaist;HoodieUp;HoodieDown;TroussHoodie") and
    TweakItemData[targetItem]["ClothingItemExtra"] == "Delran.HoodieTied;Blabla1;Blabla2;Delran.HoodieTroussed"
